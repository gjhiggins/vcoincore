...
// FIXME: gjh - pro tem 'till nHeight ~= 2000
// static constexpr int64_t STALE_CHECK_INTERVAL = 10 * 60; // 10 minutes
static constexpr int64_t STALE_CHECK_INTERVAL = 10 * 60 * 365; // 30 hours
...
static constexpr int STALE_RELAY_AGE_LIMIT = 30 * 24 * 60 * 60  * 365; // i year
