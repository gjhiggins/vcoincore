 ...
 */
static const char* BITCOIN_PID_FILENAME = "vcored.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vcoinproject/vcoincore>";
    const std::string URL_WEBSITE = "<https://vcoincore.org>";
