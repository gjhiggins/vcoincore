...
public:
    CMainParams() {
        ...
        consensus.CSVHeight = 9999999; // Block height at which CheckSequenceVerify (BIP68, BIP112 and BIP113) becomes active.
        consensus.SegwitHeight = 9999999 /*FROMGENESIS*/;
