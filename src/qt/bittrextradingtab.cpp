...
#include "ui_bittrextradingtab.h"
...
BittrexTradingTab::BittrexTradingTab(const PlatformStyle *platformStyle, QWidget *parent) :
    QWidget(parent),
    platformStyle(platformStyle),
    ui(new Ui::BittrexTradingTab),
    model(0)
{
    ui->setupUi(this);
    ...
    ui->VCNAvailableLabel->setTextFormat(Qt::RichText);
    ...
    ui->BittrexVCNLabel->setTextFormat(Qt::RichText);
    ...
    CreateOrderBookTables(*ui->BidsTable,QStringList() << "SUM(BTC)" << "TOTAL(BTC)" << "VCN(SIZE)" << "BID(BTC)");
    CreateOrderBookTables(*ui->AsksTable,QStringList() << "ASK(BTC)" << "VCN(SIZE)" << "TOTAL(BTC)" << "SUM(BTC)");
    /*OrderBook Table Init*/
...
void BittrexTradingTab::InitTrading(){
...
void BittrexTradingTab::UpdaterFunction(){
    //VCNst get the main exchange info in order to populate qLabels in maindialog. then get data
...
QString BittrexTradingTab::GetMarketSummary(){

     QString Response = sendRequest("https://bittrex.com/api/v1.1/public/GetMarketSummary?market=btc-VCN");
     return Response;
}

QString BittrexTradingTab::GetOrderBook(){

      QString  Response = sendRequest("https://bittrex.com/api/v1.1/public/getorderbook?market=BTC-VCN&type=both&depth=50");
      return Response;
}

QString BittrexTradingTab::GetMarketHistory(){
      QString Response = sendRequest("https://bittrex.com/api/v1.1/public/getmarkethistory?market=BTC-VCN&count=100");
      return Response;
}

QString BittrexTradingTab::CancelOrder(QString OrderId){
...
QString BittrexTradingTab::BuyVCN(QString OrderType, double Quantity, double Rate){
    ...
    QString URL = "https://bittrex.com/api/v1.1/market/";
            ...
            URL += "?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-VCN&quantity=";
...
QString BittrexTradingTab::SellVCN(QString OrderType, double Quantity, double Rate){
...
QString BittrexTradingTab::Withdraw(double Amount, QString Address, QString Coin){
...
QString BittrexTradingTab::GetOpenOrders(){
    QString URL = "https://bittrex.com/api/v1.1/market/getopenorders?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-VCN";

    QString Response = sendRequest(URL);
    return Response;
}

QString BittrexTradingTab::GetBalance(QString Currency){
...
QString BittrexTradingTab::GetDepositAddress(){

    QString URL = "https://bittrex.com/api/v1.1/account/getdepositaddress?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&currency=VCN";

    QString Response = sendRequest(URL);
    return Response;
}

QString BittrexTradingTab::GetAccountHistory(){

    QString URL = "https://bittrex.com/api/v1.1/account/getorderhistory?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-VCN&count=10";

    QString Response = sendRequest(URL);
    return Response;
}

int BittrexTradingTab::SetExchangeInfoTextLabels(){
    ...
    ui->volumet->setText("<b>VCN Volume:</b> <span style='font-weight:bold; font-size:12px; color:blue;'>" + str.number(obj["Volume"].toDouble(),'i',8) + "</span> VCN");
...
void BittrexTradingTab::CreateOrderBookTables(QTableWidget& Table,QStringList TableHeader){
...
void BittrexTradingTab::DisplayBalance(QLabel &BalanceLabel,QLabel &Available, QLabel &Pending, QString Currency,QString Response){
...
void BittrexTradingTab::DisplayBalance(QLabel &BalanceLabel, QString Response){
...
void BittrexTradingTab::DisplayBalance(QLabel &BalanceLabel, QLabel &BalanceLabel2, QString Response, QString Response2){
...
void BittrexTradingTab::ParseAndPopulateOpenOrdersTable(QString Response){
...
void BittrexTradingTab::CancelOrderSlot(int row, int col){
...
void BittrexTradingTab::ParseAndPopulateAccountHistoryTable(QString Response){
...
void BittrexTradingTab::ParseAndPopulateOrderBookTables(QString OrderBook){
    ...
    ui->VCNSupply->setText("<b>Supply:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(VCNSupply,'i',8) + "</span><b> VCN</b>");
    ...
    ui->VCNDemand->setText("<b>Demand:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(VCNDemand,'i',8) + "</span><b> VCN</b>");
...
void BittrexTradingTab::ParseAndPopulateMarketHistoryTable(QString Response){
...
void BittrexTradingTab::ActionsOnSwitch(int index = -1){
    ...
    switch (index){
                case 0:    //buy tab is active
                    ...
                    Response2 = GetBalance("VCN");
                    Response3 = GetOrderBook();

                    if((Response.size() > 0 && Response != "Error") && (Response2.size() > 0 && Response2 != "Error")){
                        DisplayBalance(*ui->BtcAvailableLabel, *ui->VCNAvailableLabel, Response, Response2);
                    }
                ...
                case 1: //Cross send tab active
                    ...
                    if((Response.size() > 0 && Response != "Error") && (Response2.size() > 0 && Response2 != "Error")){
                        DisplayBalance(*ui->BittrexVCNLabel, *ui->BittrexBTCLabel, Response, Response2);
                    }
                ...
                case 5://show balance tab
                    ...
                    Response = GetBalance("VCN");
                    if(Response.size() > 0 && Response != "Error"){
                        DisplayBalance(*ui->VCNBalanceLabel,*ui->VCNAvailableLabel_2,*ui->VCNPendingLabel, QString::fromUtf8("VCN"),Response);
                    }
                break;
...
void BittrexTradingTab::on_TradingTabWidget_tabBarClicked(int index){
...
QString BittrexTradingTab::sendRequest(QString url){
...
QString BittrexTradingTab::BittrexTimeStampToReadable(QString DateTime){
...
void BittrexTradingTab::CalculateBuyCostLabel(){
...
void BittrexTradingTab::CalculateSellCostLabel(){
...
void BittrexTradingTab::CalculateCSReceiveLabel(){
    ...
    double AvailableVCN = BalanceObject["Available"].toDouble();
...
void BittrexTradingTab::on_UpdateKeys_clicked(bool Save, bool Load){
...
string BittrexTradingTab::encryptDecrypt(string toEncrypt, string password) {
...
void BittrexTradingTab::on_SaveKeys_clicked(){
    bool fSuccess = true;
...
void BittrexTradingTab::on_LoadKeys_clicked(){
    bool fSuccess = true;
    boost::filesystem::path pathConfigFile = GetDataDir() / "APIcache.txt";
...
void BittrexTradingTab::on_GenDepositBTN_clicked() {
    QString response         =  GetDepositAddress();
    QJsonObject ResultObject =  GetResultObjectFromJSONObject(response);
    ui->DepositAddressLabel->setText(ResultObject["Address"].toString());
}

void BittrexTradingTab::on_Sell_Max_Amount_clicked() {
...
void BittrexTradingTab::on_Buy_Max_Amount_clicked() {
...
void BittrexTradingTab::on_CS_Max_Amount_clicked() {
    double Quantity = ui->BittrexVCNLabel->text().toDouble();
    double Received = 0;
    double Qty = 0;
    double Price = 0;
    QString buyorders = GetOrderBook();
...
void BittrexTradingTab::on_Withdraw_Max_Amount_clicked() {
    //calculate amount of currency than can be brought with the BTC balance available
    QString responseA = GetBalance("VCN");
    QString str;
    ...
    ui->WithdrawUnitsInput->setText(str.number(AvailableVCN,'i',8));
}

QJsonObject BittrexTradingTab::GetResultObjectFromJSONObject(QString response){
...
QJsonObject BittrexTradingTab::GetResultObjectFromJSONArray(QString response){
...
QJsonArray BittrexTradingTab::GetResultArrayFromJSONObject(QString response){
...
QString BittrexTradingTab::HMAC_SHA512_SIGNER(QString UrlToSign, QString Secret){
...
void BittrexTradingTab::on_SellBidcomboBox_currentIndexChanged(const QString &arg1){
    QString response = GetMarketSummary();
...
void BittrexTradingTab::on_BuyBidcomboBox_currentIndexChanged(const QString &arg1){
    QString response = GetMarketSummary();
    QJsonObject ResultObject = GetResultObjectFromJSONArray(response);
    QString Str;
...
void BittrexTradingTab::on_BuyVCN_clicked(){
    double Rate;
    double Quantity;
...
void BittrexTradingTab::on_SellVCNBTN_clicked(){
    double Rate;
    double Quantity;
...
void BittrexTradingTab::on_CSUnitsBtn_clicked(){
    double Quantity = ui->CSUnitsInput->text().toDouble();
    ...
    if(!ctx.isValid())
    {
        ...
        Q_FOREACH (const QJsonValue & value, BuyArray)
        {
            ...
            if ( ((Quantity / x) - y) > 0 )
            {
                ...
                QString SellResponse = SellVCN(Order,y,x);
                ...
                QString SellResponse = SellVCN(Order,(Quantity / x),x);
                QJsonDocument SelljsonResponse = QJsonDocument::fromJson(SellResponse.toUtf8());          //get json from str.
                QJsonObject SellResponseObject = SelljsonResponse.object();                              //get json obj
                ...
                if (SellResponseObject["success"].toBool() == false){
                    ...
                    if (ResponseObject["success"].toBool() == false){
                        ...
                        if (ResponseObject["success"].toBool() == false){
                            ...
                            QMessageBox::information(this,"Success","<center>Cross-Send Successful</center>\n Sold "+Astr.number(Qty,'i',4)+" VCN for "+Qstr.number((ui->CSUnitsInput->text().toDouble()-0.0002),'i',8)+" BTC");
                        }
                    } else if (ResponseObject["success"].toBool() == true){
                        QMessageBox::information(this,"Success","<center>Cross-Send Successful</center>\n Sold "+Astr.number(Qty,'i',4)+" VCN for "+Qstr.number((ui->CSUnitsInput->text().toDouble()-0.0002),'i',8)+" BTC");
                    }
...
void BittrexTradingTab::on_WithdrawUnitsBtn_clicked(){
...
void BittrexTradingTab::on_UnitsInputVCN_textChanged(const QString &arg1)
{
     CalculateSellCostLabel(); //update cost
}

void BittrexTradingTab::on_UnitsInput_textChanged(const QString &arg1)
{
     CalculateBuyCostLabel(); //update cost
}

void BittrexTradingTab::on_BuyBidPriceEdit_textChanged(const QString &arg1)
{
     CalculateBuyCostLabel(); //update cost
}

void BittrexTradingTab::on_SellBidPriceEdit_textChanged(const QString &arg1)
{
     CalculateSellCostLabel();
}

void BittrexTradingTab::on_CSUnitsInput_textChanged(const QString &arg1)
{
    CalculateCSReceiveLabel(); //update cost
}

void BittrexTradingTab::on_CSPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->CSUnitsAddress->setText(QApplication::clipboard()->text());
}

void BittrexTradingTab::on_WithdrawPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->WithdrawAddress->setText(QApplication::clipboard()->text());
}

void BittrexTradingTab::on_SecretPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->SecretKeyInput->setText(QApplication::clipboard()->text());
}

void BittrexTradingTab::on_KeyPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
...
void BittrexTradingTab::on_DepositCopyButton_clicked()
{
    //
    setClipboard(ui->DepositAddressLabel->text());
}

void BittrexTradingTab::setModel(WalletModel *model)
{
    // set model
    this->model = model;
}
