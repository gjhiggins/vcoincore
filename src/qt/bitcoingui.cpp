    ...
    platformStyle(_platformStyle)
{
    ...
    if(enableWallet)
    {
        ...
        exampleWindow = new exampleDialog(this);
    } else
#endif // ENABLE_WALLET
    {
    ...
    connect(openExamplewindowAction, SIGNAL(triggered()), exampleWindow, SLOT(show()));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a V Core address"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified V Core addresses"));
    ...
    openExamplewindowAction->setStatusTip(tr("Example dialog"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu *data = appMenuBar->addMenu(tr("&Extra"));
    if(walletFrame)
    {
...
void BitcoinGUI::createTrayIconMenu()
{
    ...
    trayIconMenu->addAction(openExamplewindowAction);
...
void BitcoinGUI::gotoExamplePage()
{
    openExamplewindowAction->setChecked(true);
    if (walletFrame) walletFrame->gotoExamplePage();
}
#endif // ENABLE_WALLET
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to V Core network", "", count));
}
...
{
    QString strTitle = tr("V Core"); // default title
