...
void BitcoinGUI::showWalletRepair()
{
...
void BitcoinGUI::setMining(bool mining, double hashrate)
{
    if (mining)
    {
        ...
        labelMiningStatusIcon->setToolTip(tr("Mining V Core at %1 primes per second").arg(hashrate));
    }
    else
    {
        ...
        labelMiningStatusIcon->setToolTip(tr("Not mining V Core"));
    }
