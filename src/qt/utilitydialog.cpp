    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  vcore-qt [" + tr("command-line options") + "]                     " + "\n";
...
void InscriptionDialog::on_insertButton_clicked()
{
    ...
    {
        QMessageBox::information(NULL, tr("Wallet Message"), tr("Inscriptions are limited to a maximum of 80 characters."), QMessageBox::Yes , QMessageBox::Yes);
        return;
    }
    ...
    */
    ...
    {
        QMessageBox::information(NULL, tr("Wallet Message"), tr("Inscribe on blockchain, Yes"), QMessageBox::Yes , QMessageBox::Yes);
