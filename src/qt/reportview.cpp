...
void ReportView::exportClicked()
{
    ...
    writer.addColumn(tr("Amount"), 3, Qt::EditRole);
    writer.addColumn(tr("Payments"), 4, Qt::EditRole);
...
void ReportView::showTotal()
{
    ...
    reportModel->setHorizontalHeaderItem(3, new QStandardItem(tr("Amount")));
    ...
    reportModelT2->setHorizontalHeaderItem(3, new QStandardItem(tr("Amount")));
    reportModelT2->setHorizontalHeaderItem(4, new QStandardItem(tr("Payments")));
    ...
    reportModelT->setHorizontalHeaderItem(3, new QStandardItem(tr("Amount")));
    ...
    QFont bf = reportModelT->item(0,0)->font();
    bf.setBold(true);
    reportModelT->item(0,0)->setFont(bf);
    reportModelT->item(0,1)->setFont(bf);
    reportModelT->item(0,2)->setFont(bf);
    reportModelT->item(0,3)->setFont(bf);
    reportModelT->item(0,4)->setFont(bf);
