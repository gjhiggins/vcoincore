...
"your clock is wrong VCoin Core will not work properly."),
QT_TRANSLATE_NOOP("vcoin-core", ""
...
QT_TRANSLATE_NOOP("vcoin-core", "Accept connections from outside (default: 1 if no -proxy or -connect)"),
QT_TRANSLATE_NOOP("vcoin-core", "Accept public REST requests (default: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Acceptable ciphers (default: %s)"),
QT_TRANSLATE_NOOP("vcoin-core", "Activating best chain..."),
...
QT_TRANSLATE_NOOP("vcoin-core", "Can't run with a wallet in prune mode."),
...
QT_TRANSLATE_NOOP("vcoin-core", "Connection options:"),
QT_TRANSLATE_NOOP("vcoin-core", "Copyright (C) 2009-%i The VCoin Core Developers"),
QT_TRANSLATE_NOOP("vcoin-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("vcoin-core", "Could not parse -rpcbind value %s as network address"),
QT_TRANSLATE_NOOP("vcoin-core", "Debugging/Testing options:"),
QT_TRANSLATE_NOOP("vcoin-core", "Do not load the wallet and disable wallet RPC calls"),
QT_TRANSLATE_NOOP("vcoin-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("vcoin-core", "Done loading"),
QT_TRANSLATE_NOOP("vcoin-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("vcoin-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("vcoin-core", "Error loading block database"),
QT_TRANSLATE_NOOP("vcoin-core", "Error loading wallet.dat"),
QT_TRANSLATE_NOOP("vcoin-core", "Error loading wallet.dat: Wallet corrupted"),
QT_TRANSLATE_NOOP("vcoin-core", "Error loading wallet.dat: Wallet requires newer version of Bitcoin Core"),
QT_TRANSLATE_NOOP("vcoin-core", "Error opening block database"),
QT_TRANSLATE_NOOP("vcoin-core", "Error reading from database, shutting down."),
QT_TRANSLATE_NOOP("vcoin-core", "Error"),
QT_TRANSLATE_NOOP("vcoin-core", "Error: A fatal internal error occured, see debug.log for details"),
QT_TRANSLATE_NOOP("vcoin-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("vcoin-core", "Error: Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("vcoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("vcoin-core", "Fee (in BTC/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("vcoin-core", "If <category> is not supplied, output all debugging information."),
...
QT_TRANSLATE_NOOP("vcoin-core", "Initialization sanity check failed. Bitcoin Core is shutting down."),
QT_TRANSLATE_NOOP("vcoin-core", "Insufficient funds"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid -proxy address: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid amount for -minrelaytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid amount for -mintxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid amount for -paytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Listen for connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Loading addresses..."),
QT_TRANSLATE_NOOP("vcoin-core", "Loading block index..."),
QT_TRANSLATE_NOOP("vcoin-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("vcoin-core", "Maintain at most <n> connections to peers (default: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("vcoin-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("vcoin-core", "Node relay options:"),
QT_TRANSLATE_NOOP("vcoin-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("vcoin-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("vcoin-core", "Options:"),
QT_TRANSLATE_NOOP("vcoin-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("vcoin-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("vcoin-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("vcoin-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("vcoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("vcoin-core", "RPC support for HTTP persistent connections (default: %d)"),
QT_TRANSLATE_NOOP("vcoin-core", "Rebuild block chain index from current blk000??.dat files on startup"),
...
QT_TRANSLATE_NOOP("vcoin-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("vcoin-core", "Server private key (default: %s)"),
...
QT_TRANSLATE_NOOP("vcoin-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("vcoin-core", "Specify data directory"),
QT_TRANSLATE_NOOP("vcoin-core", "Specify pid file (default: %s)"),
...
QT_TRANSLATE_NOOP("vcoin-core", "Use OpenSSL (https) for JSON-RPC connections"),
QT_TRANSLATE_NOOP("vcoin-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("vcoin-core", "Use UPnP to map the listening port (default: 1 when listening)"),
QT_TRANSLATE_NOOP("vcoin-core", "Use the test network"),
QT_TRANSLATE_NOOP("vcoin-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("vcoin-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("vcoin-core", "Verifying wallet..."),
QT_TRANSLATE_NOOP("vcoin-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("vcoin-core", "Wallet needed to be rewritten: restart Bitcoin Core to complete"),
...
QT_TRANSLATE_NOOP("vcoin-core", "Warning: Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("vcoin-core", "Warning: Unsupported argument -debugnet ignored, use -debug=net."),
