...
Plume = (function () {
    ...
    var defaultUser = {
        ...
        picture: "qrc:///plume/icon-blue.svg",
        authenticated: false
    };
                ...
                if (!container.exists && container.xhr.status < 500) {
                    ...
                    Solid.web.post(appURL, config.defaultPath, null, true).then(
                        function(res) {
                            ...
                            // add dummy post
                            var acme = {
                                title: "Welcome to Plume, a Solid blogging platform for V",
                                author: user.webid,
                                date: "3 Dec 2015",
    ...
    var getAuthorByWebID = function(webid) {
        var name = 'Unknown';
        var picture = 'qrc:///plume/icon-blue.svg';
    ...
    var postToHTML = function(post, makeLink) {
        ...
        if (user.webid == post.author) {
            ...
            edit.innerHTML = '<img src="qrc:///plume/logo.svg" alt="Edit post">Edit';
