...
{
    QMessageBox::critical(nullptr, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. V Core can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
#endif
    gArgs.AddArg("-chart", strprintf("Render difficulty and hashrate graphs (default: %u)", DEFAULT_CHARTPLOTTING), ArgsManager::ALLOW_ANY, OptionsCategory::GUI);
